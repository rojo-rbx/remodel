...
* Added support for Vector3, and improved Vector3int16 ([#45](https://github.com/rojo-rbx/remodel/issues/45))
* Added Color3.fromRGB(red, blue, green) ([#44](https://github.com/rojo-rbx/remodel/issues/44))
